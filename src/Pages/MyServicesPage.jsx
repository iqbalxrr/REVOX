              ...
              {services.map((service) => (
                <tr key={service._id} className="text-center ">
                  ...
                  <td className="px-2 py-4 border-b-2 border-gray-300 ">
                    <Link onClick={() => {document.getElementById("my_modal_3").showModal(); setUpdateServiceid(service._id) ; setUpdateService(service)}}
...
<dialog id="my_modal_3" className="modal">
  <div className="modal-box">
    ...
    <UpdateModal updateServiceid={updateServiceid}  
